...
assert.strictEqual(
  ...
  "\x1B[40meiner-color\x1B[49m"
);
assert.strictEqual(
  clc.bgRed("einer-color"),
  "\x1B[41meiner-color\x1B[49m"
);
assert.strictEqual(
  clc.bgGreen("einer-color"),
  "\x1B[42meiner-color\x1B[49m"
);
assert.strictEqual(
  clc.bgYellow("einer-color"),
  "\x1B[43meiner-color\x1B[49m"
);
assert.strictEqual(
  clc.bgBlue("einer-color"),
  "\x1B[44meiner-color\x1B[49m"
);
assert.strictEqual(
  clc.bgMagenta("einer-color"),
  "\x1B[45meiner-color\x1B[49m"
);
assert.strictEqual(
  clc.bgCyan("einer-color"),
  "\x1B[46meiner-color\x1B[49m"
);
assert.strictEqual(
  clc.bgWhite("einer-color"),
  "\x1B[47meiner-color\x1B[49m"
);

assert.deepStrictEqual(
  [clc.bgBlack("einer-color"), clc.red("einer-color")],
  ["\x1B[40meiner-color\x1B[49m","\x1B[31meiner-color\x1B[39m"]
);
